...
//main
void getEff_Jared_SingleMu_NpJpsi_0_30(TString tagString = "HLT_HIL3Mu3_v1", int kTagPath=1){
...
*/
  fcha->Add("/eos/cms/store/group/phys_heavyions/dileptons/pshukla/OniaTrigger18/BJpsiMM_0_30_OniaForest.root");
...
//  leg->AddEntry(grp_SQ[0],"L1DoubleMu0_SQ","p");
  ...
  drawText2("Nonprompt J/#psi 0<p_{T}<30GeV/c",1.5,1.2,17);
  dashedLine(0,1,15,1,1);

  c0->SaveAs("HLT_SingleMu_NpJpsi_0_30_pt.pdf");
  c0->SaveAs("HLT_SingleMu_NpJpsi_0_30_pt.png");
...
//  lege->AddEntry(gre_SQ[0],"L1DoubleMu0_SQ","p");
  ...
  drawText2("Nonprompt J/#psi 0<p_{T}<30GeV/c",-1.0, 1.2,17);
  dashedLine(-2.4,1,2.4,1,1);

  c1->SaveAs("HLT_SingleMu_NpJpsi_0_30_eta.pdf");
  c1->SaveAs("HLT_SingleMu_NpJpsi_0_30_eta.png");

  //Save the Graphs in a root file
  TFile* outFile = new TFile("HLT_SingleMu_NpJpsi_0_30.root","recreate");
  c0->Write();
  c1->Write();
  for(int k=kStart;k<Ntrig;k++){
